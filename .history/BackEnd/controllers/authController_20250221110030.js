...
export const forgotPassword = async (req, res) => {
  ...
  try {
    ...
    const transporter = nodemailer.createTransport({
      service: 'gmail',
      auth: {
        user: process.env.PASS_MAIL_USER,
    ...
    const mailOptions = {
      ...
      html: `<p>Click <a href="${process.env.CLIENT_URL}/reset-password/${resetToken}">here</a> to reset your password. This link will expire in 15 minutes.</p>`,
    };
