...
const Dashboard = () => {
  ...
  return (
    <div className="bg-gray-800 text-gray-500 w-full h-full p-4 md:w-1/4 min-w-[250px] 
     ">
 ...
 <div className="mt-4">
   <h3 className="text-lg font-semibold text-white pb-4">Financial Summary</h3>
 ...
 {/* Category Analytics */}
 <div className="mt-4">
   <h3 className="text-lg font-semibold text-white pb-4">Category Analytics</h3>

   <p>Max Spend: {maxExpenseCategory[0]} - ${maxExpenseCategory[1]}</p>
   <p>Max Income: {maxIncomeCategory[0]} - ${maxIncomeCategory[1]}</p>
 </div>
 <div className="my-4">
   <h3 className="text-lg font-semibold text-white ">Last 10 Transactions</h3>
