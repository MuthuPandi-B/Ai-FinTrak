...
const Dashboard = () => {
  ...
  return (
    <div className="bg-gray-800 text-white p-4 w-full lg:h-full  md:w-1/4 min-w-[250px] 
    shadow-md ">
   ...
   <ul>
     {filteredTransactions.map((t, index) => (
       <li key={index} className="mb-2">
         <span className="font-semibold">{t.type}:</span> {t.description} - ${t.amount.toFixed(2)}
       </li>
     ))}
   </ul>
 </div>
