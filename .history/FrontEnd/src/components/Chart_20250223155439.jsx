...
const ChartPage = () => {
  const transactions = useSelector((state) => state.transactions.data); // Assuming Redux stores transactions in 'data'
  ...
  const lastMonthExpenses = transactions
    .filter(txn => txn.type === "expense" && dayjs(txn.date).format("YYYY-MM") === lastMonth)
    .reduce((acc, txn) => {
