...
const ChartPage = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen flex flex-col lg:flex-row items-center lg:items-start space-y-8 lg:space-y-0 lg:space-x-8">
      <h1 className="text-2xl font-bold w-full text-center">Financial Overview</h1>
      ...
      <div className="w-full max-w-lg bg-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
        <h2 className="text-lg font-bold text-center">Category-wise Expenses ({lastMonthExpenses.month})</h2>
        {lastMonthExpenses.data.length > 0 ? (
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie data={lastMonthExpenses.data} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={100} fill="#8884d8" label style={{ filter: "drop-shadow(2px 2px 4px rgba(0,0,0,0.3))" }}>
