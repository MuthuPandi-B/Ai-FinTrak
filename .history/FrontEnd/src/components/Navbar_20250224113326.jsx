      ...
      <div className="hidden md:flex space-x-4">
        ...
        {user ? (
          <>
            ...
            <Link to="/transactions" className="text-white hover:text-gray-300">View Transactions</Link>
        ...
        <div className="md:hidden bg-gray-800 text-white p-4 rounded-lg mt-4 space-y-4">
          ...
          {user ? (
            <>
              ...
              <Link to="/transactions" className="block" onClick={toggleMenu}>View Transactions</Link>
