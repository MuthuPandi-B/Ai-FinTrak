const TermsAndConditions = () => {
    return (
      <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg mt-6">
        ...
        <p className="text-sm text-gray-600 text-center mb-6">Last Updated: [Date]</p>
  
        <div className="space-y-6 text-gray-700">
          <section>
            <h2 className="text-xl font-semibold mb-2">1. Acceptance of Terms</h2>
            <p>By using [Your App Name], you agree to abide by these Terms and Conditions. If you do not agree, please do not use our platform.</p>
          </section>
          ...
          <section>
            ...
            <p>Our <a href="/privacy-policy" className="text-blue-500 hover:underline">Privacy Policy</a> explains how we handle your data.</p>
          </section>
          ...
          <section>
            ...
            <p>If you have any questions, contact us at <a href="mailto:support@example.com" className="text-blue-500 hover:underline">support@example.com</a>.</p>
          </section>
        </div>
      </div>
    );
