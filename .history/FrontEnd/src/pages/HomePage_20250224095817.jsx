...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row  p-6 bg-gray-50 flex h-screen">
      ...
      <div className="hidden lg:block lg:w-1/4 lg:h-full w-full  p-6 rounded-lg shadow-md mb-6 lg:mb-0">
