...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row  p-6 bg-gray-50  overflow-hidden ">
        {/* Dashboard Button for Mobile */}
        {user && (
        <button 
          className="sm:block lg:hidden  text-white px-4 py-2 rounded-md mb-4"
      ...
      <div className="hidden lg:block  min-h-screen lg:w-1/4 h-full w-full  p-6 rounded-lg shadow-md mb-6 lg:mb-0">
