...
add reset and forgot password logics with sendmail to the user while forgot password with reset token using jwt token and send mail using nodemailer and also Includes charts for visualizing data (e.g., pie chart for expenses by category, line chart for spending trends).